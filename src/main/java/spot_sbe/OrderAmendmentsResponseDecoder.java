...
public final class OrderAmendmentsResponseDecoder
{
    public static final int BLOCK_LENGTH = 0;
    public static final int TEMPLATE_ID = 316;
    public static final int SCHEMA_ID = 3;
    public static final int SCHEMA_VERSION = 5;
    public static final String SEMANTIC_VERSION = "5.2";
    public static final java.nio.ByteOrder BYTE_ORDER = java.nio.ByteOrder.LITTLE_ENDIAN;

    private final OrderAmendmentsResponseDecoder parentMessage = this;
    ...
    public OrderAmendmentsResponseDecoder wrap(
    ...
    public OrderAmendmentsResponseDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public OrderAmendmentsResponseDecoder sbeRewind()
    {
    ...
    private final AmendmentsDecoder amendments = new AmendmentsDecoder(this);

    public static long amendmentsDecoderId()
    {
        return 100;
    }

    public static int amendmentsDecoderSinceVersion()
    {
        return 0;
    }

    public AmendmentsDecoder amendments()
    {
        amendments.wrap(buffer);
        return amendments;
    }

    public static final class AmendmentsDecoder
        implements Iterable<AmendmentsDecoder>, java.util.Iterator<AmendmentsDecoder>
    {
        public static final int HEADER_SIZE = 6;
        private final OrderAmendmentsResponseDecoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        AmendmentsDecoder(final OrderAmendmentsResponseDecoder parentMessage)
        {
        ...
        public java.util.Iterator<AmendmentsDecoder> iterator()
        {
            return this;
        }
        ...
        public static int newQtyId()
        {
            return 5;
        }

        public static int newQtySinceVersion()
        {
            return 0;
        }

        public static int newQtyEncodingOffset()
        {
            return 25;
        }

        public static int newQtyEncodingLength()
        {
            return 8;
        }

        public static String newQtyMetaAttribute(final MetaAttribute metaAttribute)
        {
            if (MetaAttribute.PRESENCE == metaAttribute)
            {
                return "required";
        ...
        public static long newQtyNullValue()
        {
            return -9223372036854775808L;
        }

        public static long newQtyMinValue()
        {
            return -9223372036854775807L;
        }

        public static long newQtyMaxValue()
        {
            return 9223372036854775807L;
        }
        ...
        public static int newClientOrderIdId()
        {
            return 202;
        }

        public static int newClientOrderIdSinceVersion()
        {
            return 0;
        }

        public static String newClientOrderIdCharacterEncoding()
        {
            return java.nio.charset.StandardCharsets.UTF_8.name();
        }

        public static String newClientOrderIdMetaAttribute(final MetaAttribute metaAttribute)
        {
            if (MetaAttribute.PRESENCE == metaAttribute)
            {
                return "required";
        ...
        public static int newClientOrderIdHeaderLength()
        {
            return 1;
        }
        ...
        public int skipNewClientOrderId()
        {
            final int headerLength = 1;
            final int limit = parentMessage.limit();
            final int dataLength = ((short)(buffer.getByte(limit) & 0xFF));
        ...
        public int getNewClientOrderId(final MutableDirectBuffer dst, final int dstOffset, final int length)
        {
            final int headerLength = 1;
            final int limit = parentMessage.limit();
            final int dataLength = ((short)(buffer.getByte(limit) & 0xFF));
        ...
        public int getNewClientOrderId(final byte[] dst, final int dstOffset, final int length)
        {
            final int headerLength = 1;
            final int limit = parentMessage.limit();
            final int dataLength = ((short)(buffer.getByte(limit) & 0xFF));
        ...
        public void wrapNewClientOrderId(final DirectBuffer wrapBuffer)
        {
            final int headerLength = 1;
            final int limit = parentMessage.limit();
            final int dataLength = ((short)(buffer.getByte(limit) & 0xFF));
        ...
        public StringBuilder appendTo(final StringBuilder builder)
        {
            ...
            builder.append('\'').append(newClientOrderId()).append('\'');
            builder.append(')');

            return builder;
        }
        
        public AmendmentsDecoder sbeSkip()
        {
            skipSymbol();
    ...
    public String toString()
    {
        ...
        final OrderAmendmentsResponseDecoder decoder = new OrderAmendmentsResponseDecoder();
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final int amendmentsOriginalOffset = amendments.offset;
        final int amendmentsOriginalIndex = amendments.index;
        final AmendmentsDecoder amendments = this.amendments();
        if (amendments.count() > 0)
        {
            while (amendments.hasNext())
            {
                amendments.next().appendTo(builder);
                builder.append(',');
            }
            builder.setLength(builder.length() - 1);
        }
        amendments.offset = amendmentsOriginalOffset;
        amendments.index = amendmentsOriginalIndex;
        builder.append(']');
    ...
    public OrderAmendmentsResponseDecoder sbeSkip()
    {
        sbeRewind();
        AmendmentsDecoder amendments = this.amendments();
        if (amendments.count() > 0)
        {
            while (amendments.hasNext())
            {
