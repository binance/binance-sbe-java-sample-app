...
public final class WebSocketSessionLogoutResponseDecoder
{
    ...
    private final WebSocketSessionLogoutResponseDecoder parentMessage = this;
    ...
    public WebSocketSessionLogoutResponseDecoder wrap(
    ...
    public WebSocketSessionLogoutResponseDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public WebSocketSessionLogoutResponseDecoder sbeRewind()
    {
    ...
    public String toString()
    {
        ...
        final WebSocketSessionLogoutResponseDecoder decoder = new WebSocketSessionLogoutResponseDecoder();
    ...
    public WebSocketSessionLogoutResponseDecoder sbeSkip()
    {
        sbeRewind();
        skipApiKey();
