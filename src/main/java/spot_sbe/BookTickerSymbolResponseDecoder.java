...
public final class BookTickerSymbolResponseDecoder
{
    public static final int BLOCK_LENGTH = 34;
    public static final int TEMPLATE_ID = 211;
    public static final int SCHEMA_ID = 1;
    public static final int SCHEMA_VERSION = 0;
    public static final String SEMANTIC_VERSION = "5.2";
    public static final java.nio.ByteOrder BYTE_ORDER = java.nio.ByteOrder.LITTLE_ENDIAN;

    private final BookTickerSymbolResponseDecoder parentMessage = this;
    ...
    public BookTickerSymbolResponseDecoder wrap(
    ...
    public BookTickerSymbolResponseDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public BookTickerSymbolResponseDecoder sbeRewind()
    {
    ...
    public String toString()
    {
        ...
        final BookTickerSymbolResponseDecoder decoder = new BookTickerSymbolResponseDecoder();
    ...
    public BookTickerSymbolResponseDecoder sbeSkip()
    {
        sbeRewind();
        skipSymbol();
