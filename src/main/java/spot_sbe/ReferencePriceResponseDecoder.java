...
public final class ReferencePriceResponseDecoder
{
    public static final int BLOCK_LENGTH = 17;
    public static final int TEMPLATE_ID = 217;
    public static final int SCHEMA_ID = 3;
    public static final int SCHEMA_VERSION = 5;
    public static final String SEMANTIC_VERSION = "5.2";
    public static final java.nio.ByteOrder BYTE_ORDER = java.nio.ByteOrder.LITTLE_ENDIAN;

    private final ReferencePriceResponseDecoder parentMessage = this;
    ...
    public ReferencePriceResponseDecoder wrap(
    ...
    public ReferencePriceResponseDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public ReferencePriceResponseDecoder sbeRewind()
    {
    ...
    public static int referencePriceId()
    {
        return 2;
    }

    public static int referencePriceSinceVersion()
    {
        return 0;
    }

    public static int referencePriceEncodingOffset()
    {
        return 1;
    }

    public static int referencePriceEncodingLength()
    {
        return 8;
    }

    public static String referencePriceMetaAttribute(final MetaAttribute metaAttribute)
    {
        if (MetaAttribute.PRESENCE == metaAttribute)
        {
            return "optional";
    ...
    public static long referencePriceNullValue()
    {
        return -9223372036854775808L;
    }

    public static long referencePriceMinValue()
    {
        return -9223372036854775807L;
    }

    public static long referencePriceMaxValue()
    {
        return 9223372036854775807L;
    }
    ...
    public String toString()
    {
        ...
        final ReferencePriceResponseDecoder decoder = new ReferencePriceResponseDecoder();
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[ReferencePriceResponse](sbeTemplateId=");
    ...
    public ReferencePriceResponseDecoder sbeSkip()
    {
        sbeRewind();
        skipSymbol();
