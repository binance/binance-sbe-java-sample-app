...
public final class NotionalFilterDecoder
{
    ...
    private final NotionalFilterDecoder parentMessage = this;
    ...
    public NotionalFilterDecoder wrap(
    ...
    public NotionalFilterDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public NotionalFilterDecoder sbeRewind()
    {
    ...
    {
        return FilterType.Notional.value();
    }
    ...
    public static int applyMinToMarketId()
    {
        return 4;
    }

    public static int applyMinToMarketSinceVersion()
    {
        return 0;
    }

    public static int applyMinToMarketEncodingOffset()
    {
        return 9;
    }

    public static int applyMinToMarketEncodingLength()
    {
        return 1;
    }

    public static String applyMinToMarketMetaAttribute(final MetaAttribute metaAttribute)
    {
        if (MetaAttribute.PRESENCE == metaAttribute)
        {
            return "required";
    ...
    public short applyMinToMarketRaw()
    {
    ...
    public static int maxNotionalId()
    {
        return 5;
    }

    public static int maxNotionalSinceVersion()
    {
        return 0;
    }

    public static int maxNotionalEncodingOffset()
    {
        return 10;
    }

    public static int maxNotionalEncodingLength()
    {
        return 8;
    }

    public static String maxNotionalMetaAttribute(final MetaAttribute metaAttribute)
    {
        if (MetaAttribute.PRESENCE == metaAttribute)
        {
            return "required";
    ...
    public static long maxNotionalNullValue()
    {
        return -9223372036854775808L;
    }

    public static long maxNotionalMinValue()
    {
        return -9223372036854775807L;
    }

    public static long maxNotionalMaxValue()
    {
        return 9223372036854775807L;
    }
    ...
    public static int applyMaxToMarketId()
    {
        return 6;
    }

    public static int applyMaxToMarketSinceVersion()
    {
        return 0;
    }

    public static int applyMaxToMarketEncodingOffset()
    {
        return 18;
    }

    public static int applyMaxToMarketEncodingLength()
    {
        return 1;
    }

    public static String applyMaxToMarketMetaAttribute(final MetaAttribute metaAttribute)
    {
        if (MetaAttribute.PRESENCE == metaAttribute)
        {
            return "required";
    ...
    public short applyMaxToMarketRaw()
    {
    ...
    {
        return buffer.getInt(offset + 19, BYTE_ORDER);
    }
    ...
    public String toString()
    {
        ...
        final NotionalFilterDecoder decoder = new NotionalFilterDecoder();
    ...
    public NotionalFilterDecoder sbeSkip()
    {
        sbeRewind();
