...
public final class NewOrderListAckResponseDecoder
{
    ...
    public NewOrderListAckResponseDecoder wrap(
    ...
    public NewOrderListAckResponseDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
        ...
        implements Iterable<OrdersDecoder>, java.util.Iterator<OrdersDecoder>
    {
        ...
        private final NewOrderListAckResponseDecoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        OrdersDecoder(final NewOrderListAckResponseDecoder parentMessage)
        {
        ...
        implements Iterable<OrderReportsDecoder>, java.util.Iterator<OrderReportsDecoder>
    {
        ...
        OrderReportsDecoder(final NewOrderListAckResponseDecoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
    ...
    public NewOrderListAckResponseDecoder sbeSkip()
    {
        sbeRewind();
