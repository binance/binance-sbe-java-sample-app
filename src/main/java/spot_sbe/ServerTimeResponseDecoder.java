...
public final class ServerTimeResponseDecoder
{
    ...
    private final ServerTimeResponseDecoder parentMessage = this;
    ...
    public ServerTimeResponseDecoder wrap(
    ...
    public ServerTimeResponseDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public ServerTimeResponseDecoder sbeRewind()
    {
    ...
    public String toString()
    {
        ...
        final ServerTimeResponseDecoder decoder = new ServerTimeResponseDecoder();
    ...
    public ServerTimeResponseDecoder sbeSkip()
    {
        sbeRewind();
