...
public final class ExchangeMaxNumOrdersFilterDecoder
{
    ...
    private final ExchangeMaxNumOrdersFilterDecoder parentMessage = this;
    ...
    public ExchangeMaxNumOrdersFilterDecoder wrap(
    ...
    public ExchangeMaxNumOrdersFilterDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public ExchangeMaxNumOrdersFilterDecoder sbeRewind()
    {
    ...
    {
        return FilterType.ExchangeMaxNumOrders.value();
    }
    ...
    public String toString()
    {
        ...
        final ExchangeMaxNumOrdersFilterDecoder decoder = new ExchangeMaxNumOrdersFilterDecoder();
    ...
    public ExchangeMaxNumOrdersFilterDecoder sbeSkip()
    {
        sbeRewind();
