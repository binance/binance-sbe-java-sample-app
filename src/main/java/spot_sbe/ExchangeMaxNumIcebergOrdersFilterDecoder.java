...
public final class ExchangeMaxNumIcebergOrdersFilterDecoder
{
    ...
    private final ExchangeMaxNumIcebergOrdersFilterDecoder parentMessage = this;
    ...
    public ExchangeMaxNumIcebergOrdersFilterDecoder wrap(
    ...
    public ExchangeMaxNumIcebergOrdersFilterDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public ExchangeMaxNumIcebergOrdersFilterDecoder sbeRewind()
    {
    ...
    {
        return FilterType.ExchangeMaxNumIcebergOrders.value();
    }
    ...
    public String toString()
    {
        ...
        final ExchangeMaxNumIcebergOrdersFilterDecoder decoder = new ExchangeMaxNumIcebergOrdersFilterDecoder();
    ...
    public ExchangeMaxNumIcebergOrdersFilterDecoder sbeSkip()
    {
        sbeRewind();
