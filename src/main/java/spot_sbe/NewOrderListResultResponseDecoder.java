...
public final class NewOrderListResultResponseDecoder
{
    ...
    private final NewOrderListResultResponseDecoder parentMessage = this;
    ...
    public NewOrderListResultResponseDecoder wrap(
    ...
    public NewOrderListResultResponseDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public NewOrderListResultResponseDecoder sbeRewind()
    {
        ...
        implements Iterable<OrdersDecoder>, java.util.Iterator<OrdersDecoder>
    {
        ...
        private final NewOrderListResultResponseDecoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        OrdersDecoder(final NewOrderListResultResponseDecoder parentMessage)
        {
        ...
        implements Iterable<OrderReportsDecoder>, java.util.Iterator<OrderReportsDecoder>
    {
        ...
        OrderReportsDecoder(final NewOrderListResultResponseDecoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
    ...
    public String toString()
    {
        ...
        final NewOrderListResultResponseDecoder decoder = new NewOrderListResultResponseDecoder();
    ...
    public NewOrderListResultResponseDecoder sbeSkip()
    {
        sbeRewind();
