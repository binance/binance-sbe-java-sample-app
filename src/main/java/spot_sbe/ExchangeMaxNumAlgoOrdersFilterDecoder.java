...
public final class ExchangeMaxNumAlgoOrdersFilterDecoder
{
    ...
    private final ExchangeMaxNumAlgoOrdersFilterDecoder parentMessage = this;
    ...
    public ExchangeMaxNumAlgoOrdersFilterDecoder wrap(
    ...
    public ExchangeMaxNumAlgoOrdersFilterDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public ExchangeMaxNumAlgoOrdersFilterDecoder sbeRewind()
    {
    ...
    {
        return FilterType.ExchangeMaxNumAlgoOrders.value();
    }
    ...
    public String toString()
    {
        ...
        final ExchangeMaxNumAlgoOrdersFilterDecoder decoder = new ExchangeMaxNumAlgoOrdersFilterDecoder();
    ...
    public ExchangeMaxNumAlgoOrdersFilterDecoder sbeSkip()
    {
        sbeRewind();
