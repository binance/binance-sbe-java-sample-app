...
public final class OrderListsResponseDecoder
{
    ...
    public OrderListsResponseDecoder wrap(
    ...
    public OrderListsResponseDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    private final OrderListsDecoder orderLists = new OrderListsDecoder(this);

    public static long orderListsDecoderId()
    {
        return 100;
    }

    public static int orderListsDecoderSinceVersion()
    {
        return 0;
    }

    public OrderListsDecoder orderLists()
    {
        orderLists.wrap(buffer);
        return orderLists;
    }

    public static final class OrderListsDecoder
        implements Iterable<OrderListsDecoder>, java.util.Iterator<OrderListsDecoder>
    {
        public static final int HEADER_SIZE = 6;
        private final OrderListsResponseDecoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        OrderListsDecoder(final OrderListsResponseDecoder parentMessage)
        {
        ...
        public java.util.Iterator<OrderListsDecoder> iterator()
        {
            return this;
        }
            ...
            implements Iterable<OrdersDecoder>, java.util.Iterator<OrdersDecoder>
        {
            ...
            OrdersDecoder(final OrderListsResponseDecoder parentMessage)
            {
                this.parentMessage = parentMessage;
            }
        ...
        public OrderListsDecoder sbeSkip()
        {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final int orderListsOriginalOffset = orderLists.offset;
        final int orderListsOriginalIndex = orderLists.index;
        final OrderListsDecoder orderLists = this.orderLists();
        if (orderLists.count() > 0)
        {
            while (orderLists.hasNext())
            {
                orderLists.next().appendTo(builder);
                builder.append(',');
            }
            builder.setLength(builder.length() - 1);
        }
        orderLists.offset = orderListsOriginalOffset;
        orderLists.index = orderListsOriginalIndex;
        builder.append(']');
    ...
    public OrderListsResponseDecoder sbeSkip()
    {
        sbeRewind();
        OrderListsDecoder orderLists = this.orderLists();
        if (orderLists.count() > 0)
        {
            while (orderLists.hasNext())
            {
