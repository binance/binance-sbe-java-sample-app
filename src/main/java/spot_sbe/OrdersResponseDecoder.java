...
public final class OrdersResponseDecoder
{
        ...
        implements Iterable<OrdersDecoder>, java.util.Iterator<OrdersDecoder>
    {
        ...
        {
            return buffer.getLong(offset + 103, BYTE_ORDER);
        }
        ...
        {
            return buffer.getLong(offset + 111, BYTE_ORDER);
        }
        ...
        {
            return buffer.getInt(offset + 127, BYTE_ORDER);
        }
        ...
        public PegPriceType pegPriceType()
        {
            ...
            return PegPriceType.get(((short)(buffer.getByte(offset + 151) & 0xFF)));
        }
        ...
        public short pegOffsetTypeRaw()
        {
            ...
            return ((short)(buffer.getByte(offset + 152) & 0xFF));
        }
        ...
        public PegOffsetType pegOffsetType()
        {
            ...
            return PegOffsetType.get(((short)(buffer.getByte(offset + 152) & 0xFF)));
        }
        ...
        public long peggedPrice()
        {
            ...
            return buffer.getLong(offset + 154, BYTE_ORDER);
        }
        ...
        public ExpiryReason expiryReason()
        {
            ...
            return ExpiryReason.get(((short)(buffer.getByte(offset + 162) & 0xFF)));
        }
