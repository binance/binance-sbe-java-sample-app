...
public final class TickerMiniResponseDecoder
{
    ...
    public TickerMiniResponseDecoder wrap(
    ...
    public TickerMiniResponseDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
        ...
        implements Iterable<TickersDecoder>, java.util.Iterator<TickersDecoder>
    {
        ...
        private final TickerMiniResponseDecoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        TickersDecoder(final TickerMiniResponseDecoder parentMessage)
        {
    ...
    public TickerMiniResponseDecoder sbeSkip()
    {
        sbeRewind();
