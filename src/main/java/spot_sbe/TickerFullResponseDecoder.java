...
public final class TickerFullResponseDecoder
{
    public static final int BLOCK_LENGTH = 0;
    public static final int TEMPLATE_ID = 214;
    public static final int SCHEMA_ID = 1;
    public static final int SCHEMA_VERSION = 0;
    public static final String SEMANTIC_VERSION = "5.2";
    public static final java.nio.ByteOrder BYTE_ORDER = java.nio.ByteOrder.LITTLE_ENDIAN;

    private final TickerFullResponseDecoder parentMessage = this;
    ...
    public TickerFullResponseDecoder wrap(
    ...
    public TickerFullResponseDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public TickerFullResponseDecoder sbeRewind()
    {
        ...
        implements Iterable<TickersDecoder>, java.util.Iterator<TickersDecoder>
    {
        ...
        private final TickerFullResponseDecoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        TickersDecoder(final TickerFullResponseDecoder parentMessage)
        {
    ...
    public String toString()
    {
        ...
        final TickerFullResponseDecoder decoder = new TickerFullResponseDecoder();
    ...
    public TickerFullResponseDecoder sbeSkip()
    {
        sbeRewind();
