...
public final class ListStatusEventDecoder
{
    public static final int BLOCK_LENGTH = 29;
    public static final int TEMPLATE_ID = 606;
    public static final int SCHEMA_ID = 3;
    public static final int SCHEMA_VERSION = 5;
    public static final String SEMANTIC_VERSION = "5.2";
    public static final java.nio.ByteOrder BYTE_ORDER = java.nio.ByteOrder.LITTLE_ENDIAN;

    private final ListStatusEventDecoder parentMessage = this;
    ...
    public ListStatusEventDecoder wrap(
    ...
    public ListStatusEventDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public ListStatusEventDecoder sbeRewind()
    {
    ...
    {
        return ContingencyType.get(((short)(buffer.getByte(offset + 24) & 0xFF)));
    }
    ...
    {
        return ListStatusType.get(((short)(buffer.getByte(offset + 25) & 0xFF)));
    }
    ...
    {
        return ListOrderStatus.get(((short)(buffer.getByte(offset + 26) & 0xFF)));
    }
    ...
    public int subscriptionId()
    {
        ...
        return (buffer.getShort(offset + 27, BYTE_ORDER) & 0xFFFF);
    }
        ...
        implements Iterable<OrdersDecoder>, java.util.Iterator<OrdersDecoder>
    {
        ...
        private final ListStatusEventDecoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        OrdersDecoder(final ListStatusEventDecoder parentMessage)
        {
    ...
    public String toString()
    {
        ...
        final ListStatusEventDecoder decoder = new ListStatusEventDecoder();
    ...
    public ListStatusEventDecoder sbeSkip()
    {
        sbeRewind();
