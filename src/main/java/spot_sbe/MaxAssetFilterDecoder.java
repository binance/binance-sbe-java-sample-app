...
public final class MaxAssetFilterDecoder
{
    ...
    private final MaxAssetFilterDecoder parentMessage = this;
    ...
    public MaxAssetFilterDecoder wrap(
    ...
    public MaxAssetFilterDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public MaxAssetFilterDecoder sbeRewind()
    {
    ...
    {
        return FilterType.MaxAsset.value();
    }
    ...
    public String toString()
    {
        ...
        final MaxAssetFilterDecoder decoder = new MaxAssetFilterDecoder();
    ...
    public MaxAssetFilterDecoder sbeSkip()
    {
        sbeRewind();
        skipAsset();
