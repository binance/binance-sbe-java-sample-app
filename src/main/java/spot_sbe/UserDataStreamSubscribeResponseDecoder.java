...
public final class UserDataStreamSubscribeResponseDecoder
{
    ...
    private final UserDataStreamSubscribeResponseDecoder parentMessage = this;
    ...
    public UserDataStreamSubscribeResponseDecoder wrap(
    ...
    public UserDataStreamSubscribeResponseDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public UserDataStreamSubscribeResponseDecoder sbeRewind()
    {
    ...
    public String toString()
    {
        ...
        final UserDataStreamSubscribeResponseDecoder decoder = new UserDataStreamSubscribeResponseDecoder();
    ...
    public UserDataStreamSubscribeResponseDecoder sbeSkip()
    {
        sbeRewind();
