...
public final class NewOrderListFullResponseDecoder
{
    public static final int BLOCK_LENGTH = 21;
    public static final int TEMPLATE_ID = 311;
    public static final int SCHEMA_ID = 3;
    public static final int SCHEMA_VERSION = 4;
    public static final String SEMANTIC_VERSION = "5.2";
    public static final java.nio.ByteOrder BYTE_ORDER = java.nio.ByteOrder.LITTLE_ENDIAN;

    private final NewOrderListFullResponseDecoder parentMessage = this;
    ...
    public NewOrderListFullResponseDecoder wrap(
    ...
    public NewOrderListFullResponseDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public NewOrderListFullResponseDecoder sbeRewind()
    {
        ...
        implements Iterable<OrdersDecoder>, java.util.Iterator<OrdersDecoder>
    {
        ...
        private final NewOrderListFullResponseDecoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        OrdersDecoder(final NewOrderListFullResponseDecoder parentMessage)
        {
        ...
        implements Iterable<OrderReportsDecoder>, java.util.Iterator<OrderReportsDecoder>
    {
        ...
        private int offset;
        private int blockLength;
        private final FillsDecoder fills;
        private final PreventedMatchesDecoder preventedMatches;

        OrderReportsDecoder(final NewOrderListFullResponseDecoder parentMessage)
        {
            this.parentMessage = parentMessage;
            fills = new FillsDecoder(parentMessage);
            preventedMatches = new PreventedMatchesDecoder(parentMessage);
        }
        ...
        {
            return BoolEnum.get(((short)(buffer.getByte(offset + 131) & 0xFF)));
        }
        ...
        public PegPriceType pegPriceType()
        {
            ...
            return PegPriceType.get(((short)(buffer.getByte(offset + 140) & 0xFF)));
        }
        ...
        public short pegOffsetTypeRaw()
        {
            ...
            return ((short)(buffer.getByte(offset + 141) & 0xFF));
        }
        ...
        public PegOffsetType pegOffsetType()
        {
            ...
            return PegOffsetType.get(((short)(buffer.getByte(offset + 141) & 0xFF)));
        }
        ...
        public long peggedPrice()
        {
            ...
            return buffer.getLong(offset + 143, BYTE_ORDER);
        }
        ...
        public short expiryReasonRaw()
        {
            ...
            return ((short)(buffer.getByte(offset + 151) & 0xFF));
        }
        ...
        public ExpiryReason expiryReason()
        {
            ...
            return ExpiryReason.get(((short)(buffer.getByte(offset + 151) & 0xFF)));
        }
            ...
            implements Iterable<FillsDecoder>, java.util.Iterator<FillsDecoder>
        {
            ...
            FillsDecoder(final NewOrderListFullResponseDecoder parentMessage)
            {
                this.parentMessage = parentMessage;
            }
            ...
            implements Iterable<PreventedMatchesDecoder>, java.util.Iterator<PreventedMatchesDecoder>
        {
            ...
            PreventedMatchesDecoder(final NewOrderListFullResponseDecoder parentMessage)
            {
                this.parentMessage = parentMessage;
            }
    ...
    public String toString()
    {
        ...
        final NewOrderListFullResponseDecoder decoder = new NewOrderListFullResponseDecoder();
    ...
    public NewOrderListFullResponseDecoder sbeSkip()
    {
        sbeRewind();
