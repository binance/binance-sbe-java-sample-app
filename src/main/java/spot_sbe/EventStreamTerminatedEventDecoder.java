...
public final class EventStreamTerminatedEventDecoder
{
    ...
    private final EventStreamTerminatedEventDecoder parentMessage = this;
    ...
    public EventStreamTerminatedEventDecoder wrap(
    ...
    public EventStreamTerminatedEventDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public EventStreamTerminatedEventDecoder sbeRewind()
    {
    ...
    public String toString()
    {
        ...
        final EventStreamTerminatedEventDecoder decoder = new EventStreamTerminatedEventDecoder();
    ...
    public EventStreamTerminatedEventDecoder sbeSkip()
    {
        sbeRewind();
