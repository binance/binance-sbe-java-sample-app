...
public final class Ticker24hSymbolFullResponseDecoder
{
    ...
    private final Ticker24hSymbolFullResponseDecoder parentMessage = this;
    ...
    public Ticker24hSymbolFullResponseDecoder wrap(
    ...
    public Ticker24hSymbolFullResponseDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public Ticker24hSymbolFullResponseDecoder sbeRewind()
    {
    ...
    public String toString()
    {
        ...
        final Ticker24hSymbolFullResponseDecoder decoder = new Ticker24hSymbolFullResponseDecoder();
    ...
    public Ticker24hSymbolFullResponseDecoder sbeSkip()
    {
        sbeRewind();
        skipSymbol();
