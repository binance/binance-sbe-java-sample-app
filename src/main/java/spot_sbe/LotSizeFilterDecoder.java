...
public final class LotSizeFilterDecoder
{
    ...
    private final LotSizeFilterDecoder parentMessage = this;
    ...
    public LotSizeFilterDecoder wrap(
    ...
    public LotSizeFilterDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public LotSizeFilterDecoder sbeRewind()
    {
    ...
    {
        return FilterType.LotSize.value();
    }
    ...
    public String toString()
    {
        ...
        final LotSizeFilterDecoder decoder = new LotSizeFilterDecoder();
    ...
    public LotSizeFilterDecoder sbeSkip()
    {
        sbeRewind();
