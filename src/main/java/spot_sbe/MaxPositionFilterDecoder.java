...
public final class MaxPositionFilterDecoder
{
    ...
    private final MaxPositionFilterDecoder parentMessage = this;
    ...
    public MaxPositionFilterDecoder wrap(
    ...
    public MaxPositionFilterDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public MaxPositionFilterDecoder sbeRewind()
    {
    ...
    {
        return FilterType.MaxPosition.value();
    }
    ...
    public static int maxPositionId()
    {
        return 3;
    }

    public static int maxPositionSinceVersion()
    {
        return 0;
    }

    public static int maxPositionEncodingOffset()
    {
        return 1;
    }

    public static int maxPositionEncodingLength()
    {
        return 8;
    }

    public static String maxPositionMetaAttribute(final MetaAttribute metaAttribute)
    {
        if (MetaAttribute.PRESENCE == metaAttribute)
        {
            return "required";
    ...
    public static long maxPositionNullValue()
    {
        return -9223372036854775808L;
    }

    public static long maxPositionMinValue()
    {
        return -9223372036854775807L;
    }

    public static long maxPositionMaxValue()
    {
        return 9223372036854775807L;
    }
    ...
    public String toString()
    {
        ...
        final MaxPositionFilterDecoder decoder = new MaxPositionFilterDecoder();
    ...
    public MaxPositionFilterDecoder sbeSkip()
    {
        sbeRewind();
