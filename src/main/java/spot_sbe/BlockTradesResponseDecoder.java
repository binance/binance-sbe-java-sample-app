...
public final class BlockTradesResponseDecoder
{
    public static final int BLOCK_LENGTH = 2;
    public static final int TEMPLATE_ID = 219;
    public static final int SCHEMA_ID = 3;
    public static final int SCHEMA_VERSION = 5;
    public static final String SEMANTIC_VERSION = "5.2";
    public static final java.nio.ByteOrder BYTE_ORDER = java.nio.ByteOrder.LITTLE_ENDIAN;

    private final BlockTradesResponseDecoder parentMessage = this;
    ...
    public BlockTradesResponseDecoder wrap(
    ...
    public BlockTradesResponseDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public BlockTradesResponseDecoder sbeRewind()
    {
    ...
    private final BlockTradesDecoder blockTrades = new BlockTradesDecoder(this);

    public static long blockTradesDecoderId()
    {
        return 100;
    }

    public static int blockTradesDecoderSinceVersion()
    {
        return 0;
    }

    public BlockTradesDecoder blockTrades()
    {
        blockTrades.wrap(buffer);
        return blockTrades;
    }

    public static final class BlockTradesDecoder
        implements Iterable<BlockTradesDecoder>, java.util.Iterator<BlockTradesDecoder>
    {
        public static final int HEADER_SIZE = 6;
        private final BlockTradesResponseDecoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        BlockTradesDecoder(final BlockTradesResponseDecoder parentMessage)
        {
        ...
        public BlockTradesDecoder next()
        {
            if (index >= count)
            {
        ...
        public java.util.Iterator<BlockTradesDecoder> iterator()
        {
            return this;
        }
        ...
        public BlockTradesDecoder sbeSkip()
        {
    ...
    public String toString()
    {
        ...
        final BlockTradesResponseDecoder decoder = new BlockTradesResponseDecoder();
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[BlockTradesResponse](sbeTemplateId=");
        ...
        builder.append('|');
        builder.append("blockTrades=[");
        final int blockTradesOriginalOffset = blockTrades.offset;
        final int blockTradesOriginalIndex = blockTrades.index;
        final BlockTradesDecoder blockTrades = this.blockTrades();
        if (blockTrades.count() > 0)
        {
            while (blockTrades.hasNext())
            {
                blockTrades.next().appendTo(builder);
                builder.append(',');
            }
            builder.setLength(builder.length() - 1);
        }
        blockTrades.offset = blockTradesOriginalOffset;
        blockTrades.index = blockTradesOriginalIndex;
        builder.append(']');
    ...
    public BlockTradesResponseDecoder sbeSkip()
    {
        sbeRewind();
        BlockTradesDecoder blockTrades = this.blockTrades();
        if (blockTrades.count() > 0)
        {
            while (blockTrades.hasNext())
            {
